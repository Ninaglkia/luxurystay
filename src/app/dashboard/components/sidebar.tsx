...
export function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex lg:flex-col w-20 bg-white border-r border-neutral-200 items-center py-6">
      {/* Logo */}
      <Link
        href="/dashboard"
        className="text-lg font-bold text-neutral-900 mb-8"
      >
        LS
      </Link>
