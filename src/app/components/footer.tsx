...
export default function Footer() {
  return (
    <footer className="bg-neutral-900 text-neutral-300 shrink-0">
      <div className="max-w-[1800px] mx-auto px-5 sm:px-6 lg:px-8 py-10 sm:py-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li>
                <Link
                  href="/"
                  className="text-sm text-neutral-400 hover:text-white transition-colors inline-block py-1.5"
                >
                  Home
                </Link>
              </li>
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="w-11 h-11 min-w-[44px] min-h-[44px] rounded-lg bg-neutral-800 flex items-center justify-center text-neutral-400 hover:bg-neutral-700 hover:text-white transition-colors"
              >
