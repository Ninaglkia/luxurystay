  ...
  if (success) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center max-w-md mx-auto px-4">
        ...
        <p className="text-lg font-semibold text-neutral-900 mb-8">Totale: &euro;{total}</p>
    ...
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      <div className="flex flex-col-reverse lg:flex-row gap-8 lg:gap-16">
        ...
        <div className="flex-1 min-w-0">
          ...
          {/* Guest info form (non-authenticated users) */}
          {!user && (
            <div className="pb-8 border-b border-neutral-200">
              <h2 className="text-[22px] font-semibold text-neutral-900 mb-2">I tuoi dati</h2>
              <p className="text-[15px] text-neutral-600 mb-5">
                Inserisci i tuoi dati per completare la prenotazione come ospite.
              </p>

              <div className="space-y-4">
                <div>
                  <label htmlFor="guestName" className="block text-sm font-medium text-neutral-700 mb-1.5">
                ...
                <div>
                  <label htmlFor="guestEmail" className="block text-sm font-medium text-neutral-700 mb-1.5">
                ...
                <div>
                  <label htmlFor="guestPhone" className="block text-sm font-medium text-neutral-700 mb-1.5">
              ...
              <p className="mt-4 text-sm text-neutral-500">
                ...
                per una prenotazione più veloce.
              </p>
            </div>
          )}

          {/* Message to host */}
          <div className="pb-8 border-b border-neutral-200 mt-0">
            <h2 className="text-[22px] font-semibold text-neutral-900 mb-2 mt-8">Scrivi un messaggio all&apos;host</h2>
            <p className="text-[15px] text-neutral-600 mb-5">
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1">
                ...
                <p className="text-sm text-neutral-600">
                  Si, aggiungi per <strong className="text-neutral-900">&euro;{Math.round(subtotal * 0.05)}</strong>.
                  <br />
              ...
              <div className="pt-4">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-neutral-900">&euro;{subtotal.toLocaleString("it-IT")}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-neutral-600">Costi del servizio</span>
                    <span className="text-neutral-900">&euro;{serviceFee.toLocaleString("it-IT")}</span>
                  </div>
                  {addInsurance && (
                    <div className="flex justify-between text-sm">
                      <span className="text-neutral-600">Assicurazione viaggio</span>
                      <span className="text-neutral-900">&euro;{insuranceFee.toLocaleString("it-IT")}</span>
                    </div>
                  )}
                </div>
                ...
                <div className="flex justify-between font-semibold">
                  ...
                  <span className="text-neutral-900">&euro;{total.toLocaleString("it-IT")}</span>
                </div>
